...
{
    public float GetAtomicMass(string elementSymbol)
    {
        Dictionary<string, float> atomicMasses = new ()
        {
            ...
            { "Mn", 54.938f }/*Manganese*/, { "Fe", 55.845f }/*Iron*/, { "Co", 58.933f }/*Cobolt*/, { "Ni", 58.693f }/*Nickel*/,
        ...
        if (atomicMasses.ContainsKey(elementSymbol))
        {
